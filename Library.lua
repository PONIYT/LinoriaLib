...
backgroundFrame.BackgroundColor3 = Color3.fromRGB(15, 10, 4)
...
JesterButton.BackgroundColor3 = Color3.fromRGB(255, 157, 46)
...
local Library = {
	...
	AccentColor = Color3.fromRGB(0, 180, 90),
...
function Library:CreateWindow(...)
	...
	local Outer = Library:Create('Frame', {
	    Name = "windowFrame", -- Define o nome do frame
